    ...
    return (
      <>
          <div className={styles.adaptive}>
                          ...
                          objectForLinks.map(({
                              ...
                              return (
                                <div className={styles.burgerMenuBlock} key={id}>
                                    <Link to={linkTo} className={styles.burgerMenuLink}
                                          onClick={() => onBurgerOpenFlag(false)}> {linkName} </Link>
                                </div>
                              );
                          })
                      }
              ...
              <button className={styles.burgerIcon} onClick={() => onBurgerOpenFlag(true)}
                      aria-label="burger"><BurgerIcon/></button>
